...
public class MoveAllPlayersListener extends SocketListener<Action2<UUID, UUID>> {
    ...
    public Action2<UUID, UUID> getAction() {
        return (fromServerId, toServerId) -> this.sees.call(new MoveAllPlayersEvent(fromServerId, toServerId));
    }
}
