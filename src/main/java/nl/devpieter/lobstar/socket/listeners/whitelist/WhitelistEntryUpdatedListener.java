...
public class WhitelistEntryUpdatedListener implements ISocketListener<Action2<UUID, WhitelistEntry>> {
    ...
    public Action2<UUID, WhitelistEntry> getAction() {
        return (entryId, entry) -> this.sees.call(new WhitelistEntryUpdatedEvent(entryId, entry));
    }
}
